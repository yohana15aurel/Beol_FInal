...
public class callback_read_register extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public callback_read_register(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1317012/mst_read_register.php",
                "POST", paramsed);
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                   ...
                   // map.put("id_user", c.getString("id_user"));
                    map.put("name", c.getString("name"));
                    map.put("email", c.getString("email"));
                    map.put("birthdate", c.getString("birthdate"));
                    map.put("mobilephone", c.getString("mobilephone"));
                    map.put("img_profile", c.getString("img_profile"));
