...
public class callback_read_cuci_mobil extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public callback_read_cuci_mobil(Context m_context) {
