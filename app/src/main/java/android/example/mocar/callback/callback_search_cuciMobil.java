...
public class callback_search_cuciMobil extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public callback_search_cuciMobil(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        paramsed.add(new BasicNameValuePair("alamat_cuci_mobil", params[0])); //id


        JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1317012/mst_search_cuci_mobil.php",
                "POST", paramsed);
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    map.put("id_cuci_mobil", c.getString("id_cuci_mobil"));
                    map.put("nama_cuci_mobil", c.getString("nama_cuci_mobil"));
                    map.put("alamat_cuci_mobil", c.getString("alamat_cuci_mobil"));
