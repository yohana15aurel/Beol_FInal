...
public class callback_read_konsul extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public callback_read_konsul(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1317012/mst_read_konsul.php",
                "POST", paramsed);
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    map.put("id_konsul", c.getString("id_konsul"));
                    map.put("judulKonsul", c.getString("judulKonsul"));
                    map.put("isiKonsul", c.getString("isiKonsul"));
                    map.put("img_konsul", c.getString("img_konsul"));
