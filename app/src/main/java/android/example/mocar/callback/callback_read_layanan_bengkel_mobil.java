...
public class callback_read_layanan_bengkel_mobil extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public callback_read_layanan_bengkel_mobil(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        paramsed.add(new BasicNameValuePair("id_bengkel", params[0])); //id


        JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1317012/mst_read_layanan_bengkelMobil.php",
                "POST", paramsed);
