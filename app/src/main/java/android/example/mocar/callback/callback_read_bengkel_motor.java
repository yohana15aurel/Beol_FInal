...
public class callback_read_bengkel_motor extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public callback_read_bengkel_motor(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1317012/mst_read_bengkel_motor.php",
                "POST", paramsed);
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    map.put("kontak_motor", c.getString("kontak_motor"));
